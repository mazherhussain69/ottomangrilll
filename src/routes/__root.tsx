...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ottoman Turkish Grill & Cuisine" },
      { name: "description", content: "Authentic halal Turkish cuisine in Mississauga and North York." },
      { name: "author", content: "Ottoman Turkish Grill and Cuisine" },
      { property: "og:title", content: "Ottoman Turkish Grill & Cuisine" },
